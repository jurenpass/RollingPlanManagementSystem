...
class FurnaceOrderManager:
    ...
    def furnace_details(self):
        ...
        # 创建主框架
        main_frame = tk.Frame(detail_window, bg='#f0f0f0', padx=10, pady=10)
        main_frame.pack(fill=tk.BOTH, expand=True)
        ...
        # 设置Treeview样式 - 字体大小16，行高80（增加行高以容纳更多文本）
        style = ttk.Style(detail_window)
        style.configure('Custom.Treeview', font=('微软雅黑', 16), rowheight=80)
        style.configure('Custom.Treeview.Heading', font=('微软雅黑', 16, 'bold'))
        ...
        # 列名
        columns = [
            "装炉顺序", "计划号", "钢卷号", "牌号（钢级）", "除鳞", "去向",
            "坯厚", "坯宽", "坯长", "中厚", "轧厚", "轧宽", "订宽",
            "切边", "调宽", "减宽", "公差带", "RT2", "强度", "粗轧报信"
        ]
        ...
        status_label = tk.Label(bottom_frame, text="正在加载...", 
                              bg='#f0f0f0', fg='#333333', font=('微软雅黑', 12, 'bold'))
        ...
        # 左侧空格
        left_spacer = tk.Frame(button_container, bg='#f0f0f0')
        ...
        # 右侧空格
        right_spacer = tk.Frame(button_container, bg='#f0f0f0')
                ...
                if plan_file:
                    ...
                    if coil_data:
                        ...
                        row_data = [
                            ...
                            coil_no,
                            coil_data.get('grade', ''),
                            coil_data.get('scaling', ''),
                            coil_data.get('destination', ''),
                            coil_data.get('blank_thick', ''),
                            coil_data.get('blank_width', ''),
                            coil_data.get('blank_length', ''),
                            coil_data.get('middle_thick', ''),
                            coil_data.get('roll_thick', ''),
                            coil_data.get('roll_width', ''),
                            coil_data.get('order_width', ''),
                            coil_data.get('edge_cut', ''),
                            coil_data.get('width_adjust', ''),
                            coil_data.get('width_reduce', ''),
                            coil_data.get('tolerance', ''),
                            coil_data.get('rt2', ''),
                            coil_data.get('strength', ''),
                            coil_data.get('rough_rolling', '')
                        ]
