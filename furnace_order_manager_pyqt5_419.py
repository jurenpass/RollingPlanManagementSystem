...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # 测试标签显示
        print("设置测试标签文本")
        self.next_execution_label.setText("下一次执行: 测试")
...
class FurnaceDetailsWindow(QMainWindow):
    ...
    def show_context_menu(self, event):
        ...
        def on_find_coil_number():
            ...
            input_dialog.setFont(QFont("微软雅黑", 16))
    ...
    def add_plan_data_to_table(self, plan_data, plan_no, coil_no):
        ...
        try:
            ...
            for col_idx, value in enumerate(row_data):
                ...
                elif col_name == "除鳞" and isinstance(value, str) and ('回' in value or '无APS' in value):
                    # 设置红色背景
                    item.setBackground(QBrush(QColor('#FF0000')))
                    # 添加annotation属性，用于样式表识别
                    item.setData(Qt.UserRole, True)
                # 其他高亮处理
                    ...
                    self.process_cell_highlight(item, col_name, str(value))
