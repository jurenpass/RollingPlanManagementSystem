...
# 找到FurnaceDetailsWindow类的结束位置
furnace_details_end = content.find('class SettingsWindow(QDialog):')

# 提取FurnaceDetailsWindow类的内容
furnace_details_content = content[:furnace_details_end]

# 提取SettingsWindow类的内容
settings_content = content[furnace_details_end:]

# 找到需要移动的方法
methods_to_move = '''    def connect_signals(self):
        """连接信号"""
        # 连接按钮信号
