...
class ExportConfigGUI:
    ...
    def create_widgets(self):
        ...
        def on_focus_out(event):
            ...
            try:
                ...
                if not (30 <= value <= 999):
                    ...
                    self.main_app.custom_messagebox("错误", "请输入30-999之间的数值")
        ...
        ttk.Label(anti_logout_frame, text="(30-999)", foreground="gray").pack(side=tk.LEFT, padx=5)
        ...
        def on_exec_interval_focus_out(event):
            ...
            try:
                ...
                if not (5 <= value <= 999):
                    ...
                    self.main_app.custom_messagebox("错误", "请输入5-999之间的数值")
        ...
        ttk.Label(interval_mode_frame, text="(5-999)", foreground="gray").pack(side=tk.LEFT, padx=5)
